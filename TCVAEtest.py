...
audio_dir = os.path.join(os.path.dirname(__file__), 'Flute/aeolian/')
AUDIO_PATH = os.path.join(audio_dir, 'Fl-aeol-F4-p-N-N.wav')
SAMPLE_RATE = 44100
N_MELS = 64
N_FFT = 2048
HOP_LENGTH = 512
...
dummy_z = torch.zeros(32) # média 0, std 1
