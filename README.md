# Transformer Conditioned Variational Autoencoder (T-CVAE)
...
Decoder: Concatena z (latente) expandido com tgt. Projeta (target_features + latent_dim) → d_model. Adiciona positional encoding. Pilha de DecoderLayer.
